...
export function Sidebar() {
  ...
  const handleSaveRename = async (id: string) => {
    if (
      editTitle.trim() &&
      editTitle.trim() !== sessions.find((s) => s.id === id)?.title
    ) {
